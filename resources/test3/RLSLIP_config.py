...
class RLSLIPCfg( LeggedRobotCfg ):
    ...
    class commands( LeggedRobotCfg.commands ):
        ...
        class ranges:
            lin_vel_x = [-0.10, 0.10] # min max [m/s]
            lin_vel_y = [-0.10, 0.10]   # min max [m/s]
    ...
    class control( LeggedRobotCfg.control ):
        control_type = 'P'
        # PD Drive parameters:
        stiffness = {   'xdof': 1500.0, 'ydof': 1500.0, 'zdof': 1500.0}  # [N*m/m]
        damping = {   'xdof':15.0, 'ydof': 15.0, 'zdof': 15.0}  # [N*m/m/s]
